...
class Project extends Component {
  componentDidMount() {
    ...
    console.log(projects.find(p => p._id === this.props.location.pathname.split("/project/")[1]))
  }
  ...
  render() {
    return (
      ...
      //     <div>
      <BlocklyEditor
        project={projects.find(p => p._id === this.props.location.pathname.split("/project/")[1])}
