...
class ProjectHome extends Component {
  ...
  render() {
    var data = this.props.location.pathname === '/projects' ? 'Projekte' : 'Galerie';
    return (
      <div>
...
export default connect(mapStateToProps)(withStyles(styles, { withTheme: true })(withRouter(ProjectHome)));